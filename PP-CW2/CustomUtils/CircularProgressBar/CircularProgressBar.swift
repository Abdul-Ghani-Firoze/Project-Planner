...
class CircularProgressBar: UIView {
    ...
    public func setProgress(to progressConstant: Double, withAnimation: Bool, type: String) {
    ...
    private func configLabel(for type: String){
        if(type != "days") {
            label.text?.append("%")
        }
        label.sizeToFit()
