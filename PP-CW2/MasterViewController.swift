...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(nib, forCellReuseIdentifier: "ProjectTableViewCell")
    ...
    func configureCell(_ cell: ProjectTableViewCell, withProject project: Project) {
        cell.projectName!.text = project.project_name
        cell.projectNotes!.text = project.notes
        
        let dateFormatter = DateFormatter()
        dateFormatter.dateStyle = DateFormatter.Style.medium
        cell.dueDate!.text = dateFormatter.string(from: project.due_date!)
        ...
        var no_of_tasks = 0
        for task in (project.tasks)! as! Set<Task> {
        ...
        cell.progressBar.safePercent = 70
        cell.progressBar.setProgress(to: (Double(overallProgress) / 100), withAnimation: true, type: "")
    }
    ...
    var fetchedResultsController: NSFetchedResultsController<Project> {
        ...
        let sortDescriptor = NSSortDescriptor(key: "project_name", ascending: true)
